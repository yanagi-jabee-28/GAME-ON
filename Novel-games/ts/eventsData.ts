...
export const EVENTS = {
	...
	HIDE_PLAY_ACTION: {
		message:
			"後ろの方でこっそりスマホで遊んだり、友達と小さく盛り上がった。気分転換になった。",
		// 隠れて遊ぶは精神力を回復する
...
export const RANDOM_EVENTS = {
	PROFESSOR_TALK: {
		...
		message:
			"物理の教授の雑談が白熱し、授業そっちのけで宇宙の神秘について語り始めた...",
		choices: [
			{
				text: "興味深く聞く",
				consequences: {
			...
			},
			{
				...
				consequences: {
					...
					success: {
						...
						changes: { stats: { academic: 5 } },
					},
					failure: {
						message: "内職が教授にバレてしまい、気まずい思いをした...",
						changes: { stats: { mental: -10 } },
					},
				},
			},
		],
	...
	SOLDER_CHALLENGE: {
		...
		choices: [
			...
			},
			{
				...
				consequences: {
					message:
						"友人に助けてもらい、難なく乗り切ることができた。持つべきものは友だ。",
					changes: { cp: -1 },
				},
			},
		],
		...
		choices: [
			{
				...
				consequences: {
					message:
						"背徳感と共にすするラーメンは格別だった。明日から頑張ろう...",
					changes: { money: -500, stats: { mental: 15, physical: -10 } },
				},
			},
			{
				text: "断って勉強する",
	...
	JUNK_PC_REBUILD: {
		...
		conditions: { turn: ["放課後"] },
		message:
			"友人がガラクタ同然のPCを拾ってきた。「一緒に直さないか？」と持ちかけられる。",
		choices: [
			{
				text: "修理を手伝う",
				consequences: {
					...
					success: {
						...
						changes: { physical: -20, money: 2000, cp: 5 },
					},
					failure: {
