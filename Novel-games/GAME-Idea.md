...
- 所持金: バイト経験の有無に加え、「実家との関係」に関する質問で初期値が大きく変動。運が良ければ、親からの潤沢な支援で「大富豪」スタートも可能。逆に、関係が悪いと「極貧」状態からのスタートも。家庭の事情は、そうそう変わるものではない。
- 基礎学力: 1年間の真面目さで変動。
...
- 実験レポート: 作業寄り。学力は上がらず、時間とコンディションを消耗する「負債」。
