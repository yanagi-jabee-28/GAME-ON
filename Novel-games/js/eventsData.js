...
const RANDOM_EVENTS = {
	...
	"SOLDER_CHALLENGE": {
		...
		choices: [
			{ text: "自信満々で挑む", consequences: { probability: 0.5, success: { message: "見事なはんだ付けを披露し、友人たちから尊敬の眼差しを受けた。", changes: { cp: 5 } }, failure: { message: "手を滑らせてしまい、基盤を焦がしてしまった...", changes: { physical: -5 } } } },
			{ text: "得意な友人に助けを求める", consequences: { message: "友人に助けてもらい、難なく乗り切ることができた。持つべきものは友だ。", changes: { cp: -1 } } }
		]
	},
	"MIDNIGHT_RAMEN": {
		id: "MIDNIGHT_RAMEN",
		...
		choices: [
			{ text: "誘いに乗る", consequences: { message: "背徳感と共にすするラーメンは格別だった。明日から頑張ろう...", changes: { money: -500, stats: { mental: 15, physical: -10 } } } },
	...
	"JUNK_PC_REBUILD": {
		...
		choices: [
			{ text: "修理を手伝う", consequences: { probability: 0.6, success: { message: "苦労の末、PCは息を吹き返した！お礼にいくらか貰えた。", changes: { physical: -20, money: 2000, cp: 5 } }, failure: { message: "結局、PCが直ることはなく、ただただ疲れただけだった...", changes: { physical: -20 } } } },
